...
На этапе MVP для ускорения разработки предлагается создать синтетических токен, привязанный к индексу акций 5 наиболее активных SPAC, см. https://github.com/UMAprotocol/UMIPs/pull/399
