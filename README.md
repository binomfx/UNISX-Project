...
Для **получения начисленного вознаграждения** пользователь должен выбрать в портфеле строку с NFT токеном UNISWAP и нажать кнопку CLAIM REWARDS.
