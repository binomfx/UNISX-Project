...
- выбрать строку соответствующего инструмента в таблице инструментов
- дозаполнить остальные поля 
- и нажать кнопку MINT. При нажатии вызывается функция mintUSX ();
...
- указать количество сжигаемых токенов 
- и нажать кнопку BURN.
